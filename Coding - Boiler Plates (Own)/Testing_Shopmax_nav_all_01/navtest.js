...
const sellinvestplandrop_btn = document.querySelector(
  ".sellinvestplandrop-btn"
);
const sellinvestplantooltip = document.querySelector(".sellinvestplantooltip");
const sellinvestplanmenu_wrapper = document.querySelector(
  ".sellinvestplanwrapper"
);
const sellinvestplanmenu_bar = document.querySelector(
  ".sellinvestplanmenu-bar"
);

// ==============================================  TODO:  SHOP MARKETPLACE & SERVICES  TODO:

const shopmarketplacedrop_btn = document.querySelector(
  ".shopmarketplacedrop-btn"
);
const shopmarketplacetooltip = document.querySelector(
  ".shopmarketplacetooltip"
);
const shopmarketplacemenu_wrapper = document.querySelector(
  ".shopmarketplacewrapper"
);
const shopmarketplacemenu_bar = document.querySelector(
  ".shopmarketplacemenu-bar"
);
...
sellinvestplandrop_btn.onclick = () => {
  sellinvestplanmenu_wrapper.classList.toggle("show");
  sellinvestplantooltip.classList.toggle("show");
};

// ==============================================  TODO:  SHOP MARKETPLACE & SERVICES  TODO:

shopmarketplacedrop_btn.onclick = () => {
  shopmarketplacemenu_wrapper.classList.toggle("show");
  shopmarketplacetooltip.classList.toggle("show");
};
...
back_sellingplans_btn.onclick = () => {
  sellinvestplanmenu_bar.style.marginLeft = "0rem";
...
back_marketplaceproducts_btn.onclick = () => {
  shopmarketplacemenu_bar.style.marginLeft = "0rem";
...
covid19_item.onclick = () => {
  shopessentialproductsmenu_bar.style.marginLeft = "-18rem";
  setTimeout(() => {
...
freshproduce_item.onclick = () => {
  shopessentialproductsmenu_bar.style.marginLeft = "-36rem";
  setTimeout(() => {
...
ladiesshoes_item.onclick = () => {
  shopessentialproductsmenu_bar.style.marginLeft = "-54rem";
  setTimeout(() => {
